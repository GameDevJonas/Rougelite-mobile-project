...
public class Item
{
    ...
    public Item(int id, string tier, string title, string lore, string description, /*icon,*/ CharacterStat statType, string modType, float statValue, int amount, int collection)
    {
        this.id = id;
        this.tier = tier;
        this.title = title;
